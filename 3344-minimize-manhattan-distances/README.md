<h2><a href="https://leetcode.com/problems/minimize-manhattan-distances">3344. Minimize Manhattan Distances</a></h2><h3>Hard</h3><hr><p>You are given a array <code>points</code> representing integer coordinates of some points on a 2D plane, where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>.</p>

<h2><a href="https://leetcode.com/problems/delete-columns-to-make-sorted-ii/description/">992. Delete Columns to Make Sorted II</a></h2><h3>Medium</h3><hr><p>You are given an array of <code>n</code> strings <code>strs</code>, all of the same length.</p>
